...
def main():
    ...
    if not trades_path.exists():
        print(f"ERROR: Portfolio trades file not found: {trades_path}")
        print(f"       Stage A requires portfolio_trades.csv with executed trades.")
        print(f"       This file should be generated by Reporter.save_portfolio_trades_table()")
        return
    ...
    print(f"Portfolio trades file: {trades_path}")
